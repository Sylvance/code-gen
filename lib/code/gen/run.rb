  ...
  module Gen
    ...
    class Run
      ...
      def target_folder_path
        Code::Gen.settings.target_folder_path
      end

      def target_filename
        Code::Gen.settings.target_filename
      end

      def dataset_path
        Code::Gen.settings.dataset_path
      end

      def section_join_char
        Code::Gen.settings.section_join_character
      end

      def template_path
        Code::Gen.settings.template_path
      end
    end
  end
end
